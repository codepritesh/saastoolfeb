...
import requests
import traceback
from two_way_sp_strategy_bot import *
from threading import Thread
import json

class TwoWaySpToolConsumer(BaseConsumer):
    BOT_ALIAS = TwoWaySpBot.bot_alias
    ...
    def receive(self, text_data):
        ...
        if signal == 'start':
            try:
                ...
                print('ERROR: TwoWaySpToolConsumer: {}'.format(tb))
                return False
        if signal == 'stop':
            try:
